...
/**
 * Component for viewing the outbox messages.
 */
@Component({
  selector: 'app-outbox',
...
export class OutboxComponent implements OnInit {
  ...
  /**
   * Initialize the component by fetching outbox messages.
   */
  ngOnInit(): void {
    this.viewOutbox();
  }
  ...
  /**
   * Fetches outbox messages from the API.
   */
  viewOutbox() {
    this.apiService.getMessages(
      'out', this.p, this.itemsPerPage, this.sortField, this.sortOrder,
      '', this.filterReceiver, this.filterContent, this.startDate, this.endDate
    ).subscribe(data => {
